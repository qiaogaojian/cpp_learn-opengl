...
int main()
{
    ...
    char *vsScreenPath = "/src/4.5 Framebuffers/practice1_screen.vert";
    char *fsScreenPath = "/src/4.5 Framebuffers/practice1_screen.frag";
    ...
    // load textures
    // -------------
    string cubeTexturePath = concatString(getcwd(NULL, 0), "/res/texture/box.jpg");
